...
Accounts.emailTemplates.siteName = 'Marston by EE'
Accounts.emailTemplates.from = 'luc@lyb.re'

Accounts.emailTemplates.enrollAccount.subject = (user) => {
  return `Welcome to Marston by Encrypted Energy, ${user.name}`
}
...
Accounts.emailTemplates.resetPassword.from = () => {
  ...
  // passwords.
  return 'Marston by EE <luc@lyb.re>'
}
...
Accounts.emailTemplates.resetPassword.text = (user, url) => {
  return `Hi ${user.name}, \n\nA password reset request was triggered for your Marston by EE acount.` +
